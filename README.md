...
- An <ins>informal feedback session</ins>, once again consisting of Software Engineering students, aimed to reveal preferences for Tee-Together's scorecard system.
- A <ins>prototype</ins> of Tee-Together, which recreates the intended user interface in high fidelity, has now been created from our previous wireframe, allowing for the simulation of **geniune user interaction**.
